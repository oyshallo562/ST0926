package com.appplepi.retrofithwapp
...
import com.appplepi.retrofithwapp.ui.dashboard.DashboardFragment
import java.util.regex.Matcher
import java.util.regex.Pattern


class LunchAdapter(val lunch: List<LunchModel>?, mainActivity: DashboardFragment) :
